...
export const configSchema = {
    ...
    properties: {
        ...
        prettier: {
            type: "object",
            description: "Prettier formatting options. Merged with defaults: singleQuote=true, trailingComma='all', semi=false, tabWidth=2, printWidth=60. The parser and plugins cannot be overridden.",
            properties: {
                singleQuote: {
                    type: "boolean",
