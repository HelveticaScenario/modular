...
struct ChiptuneOscillatorParams {
    /// frequency in v/oct
    freq: Signal,
    /// timbre parameter (0-1): arpeggio type or chord inversion
    timbre: Signal,
    /// morph parameter (0-1): PW/Sync
    morph: Signal,
    /// harmonics parameter (0-1): chord selection
    harmonics: Signal,
...
#[module("mi.chiptune", "Chiptune waveforms with arpeggiator")]
#[args(freq)]
pub struct ChiptuneOscillator {
    outputs: ChiptuneOscillatorOutputs,
    engine: Option<ChiptuneEngine>,
...
message_handlers!(impl ChiptuneOscillator {});
