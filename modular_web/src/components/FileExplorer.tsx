...
export function FileExplorer({
  ...
  const renderLabel = (file: string) => (formatLabel ? formatLabel(file) : file);
    ...
    <div className="file-explorer">
      <div className="file-explorer-header">
        ...
        <div className="file-explorer-actions">
          <button onClick={onCreateFile} title="New file" className="action-button">
            New
          </button>
          <button onClick={onSaveFile} title="Save current file" className="action-button">
            Save
          </button>
          <button onClick={onRenameFile} title="Rename current file" className="action-button">
            Rename
          </button>
              ...
              <ul>
                {openFiles.map((file) => {
                  ...
                  return (
                    ...
                    >
                      <span className="file-name">{renderLabel(file)}</span>
                      {state.isNew && <span className="badge">new</span>}
