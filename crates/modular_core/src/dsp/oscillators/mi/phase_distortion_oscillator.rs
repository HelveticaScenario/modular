...
use mi_plaits_dsp::{
    ...
    engine2::phase_distortion_engine::PhaseDistortionEngine,
};
...
#[serde(default)]
struct PhaseDistortionOscillatorParams {
    freq: Signal,
    timbre: Signal,
    morph: Signal,
    harmonics: Signal,
...
#[module("mi.phasedist", "Phase distortion synthesis")]
#[args(freq)]
pub struct PhaseDistortionOscillator {
    outputs: PhaseDistortionOscillatorOutputs,
    engine: Option<PhaseDistortionEngine>,
    buffer_out: Vec<f32>,
    buffer_aux: Vec<f32>,
    buffer_pos: usize,
    last_sync: f32,
...
message_handlers!(impl PhaseDistortionOscillator {});
