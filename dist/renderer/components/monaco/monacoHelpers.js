...
exports.applyDslLibToMonaco = applyDslLibToMonaco;
...
function applyDslLibToMonaco(monaco, libSource) {
    if (!monaco || !libSource)
        return {};
...
function formatPath(currentFile) {
...
//   return model;
// }
//# sourceMappingURL=monacoHelpers.js.map