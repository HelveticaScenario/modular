...
exports.createScopeViewZones = createScopeViewZones;
function createScopeViewZones({ editor, monaco, views, onRegisterScopeCanvas, onUnregisterScopeCanvas, }) {
    const viewZoneIds = [];
    const scopeCanvasMap = new Map();
...
//# sourceMappingURL=scopeViewZones.js.map