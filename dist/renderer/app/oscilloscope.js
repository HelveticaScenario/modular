...
exports.drawOscilloscope = exports.scopeKeyFromSubscription = void 0;
const scopeKeyFromSubscription = (subscription) => {
    const { moduleId, portName } = subscription;
    return `:module:${moduleId}:${portName}`;
};
exports.scopeKeyFromSubscription = scopeKeyFromSubscription;
const drawOscilloscope = (channels, canvas, options = {}) => {
...
exports.drawOscilloscope = drawOscilloscope;
