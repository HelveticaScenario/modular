...
pub fn install_constructors(map: &mut HashMap<String, SampleableConstructor>) {
    ...
    schmitt_trigger::SchmittTriggerModule::install_constructor(map);
}
...
pub fn install_param_validators(map: &mut HashMap<String, ParamsValidator>) {
    ...
    schmitt_trigger::SchmittTriggerModule::install_params_validator(map);
}
...
pub fn schemas() -> Vec<ModuleSchema> {
    vec![
        ...
        schmitt_trigger::SchmittTriggerModule::get_schema(),
    ]
}
