...
exports.oneDarkPro = {
    ...
    tokenColors: [
        ...
        { scope: ['entity.name.type', 'support.type'], settings: { foreground: '#e5c07b' } },
        { scope: ['punctuation'], settings: { foreground: '#abb2bf' } },
        { scope: ['constant.other', 'variable.other.constant'], settings: { foreground: '#d19a66' } },
    ],
};
